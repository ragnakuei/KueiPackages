...
{
    public class LeftJoinAppendRightTests
    {
        [Test]
        public void OneColumn()
        {
            ...
            var actual = leftDt.LeftJoinAppendRight(rightDt, new IdDataRowComparer())
                               .AsEnumerable()
                               .Select(r => new
                                            {
                                                Id   = r.Field<int>("Id"),
            ...
            var expected = new[]
                           {
                               ...
                               new { Id = 4, Name = (string)null, Age = (int?)20 },
                           };
        ...
        public void TwoColumn()
        {
            ...
            var actual = leftDt.LeftJoinAppendRight(rightDt, new IdNameDataRowComparer())
                               .AsEnumerable()
                               .Select(r => new
                                            {
                                                Id      = r.Field<int>("Id"),
            ...
            var expected = new[]
                           {
                               ...
                               new { Id = 4, Name = "John", Age = (int?)20, Address   = (string)null, },
                           };
